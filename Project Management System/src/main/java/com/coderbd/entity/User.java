...
public class User {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, userName, password, email, mobile, gender, regiDate, lastModifiedDate, birthDate, enabled, confirmationToken, tokenExpired, fileSize, fileName, filePath, fileExtension, roles, company);
    }
}
